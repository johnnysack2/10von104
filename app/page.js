            ...
            <div className="card" style={{ padding: result ? '1rem' : '2rem', marginTop: result ? '0.5rem' : '2rem' }}>
                {!preview ? (
                    ...
                    <div style={{ textAlign: 'center' }}>
                        <img src={preview} alt="Preview" style={{ maxWidth: '100%', maxHeight: result ? '130px' : '400px', borderRadius: '10px', marginBottom: result ? '0.5rem' : '1rem', border: '1px solid #333', transition: 'all 0.5s ease', objectFit: 'contain' }} />
                        {!result && (
                ...
                {result && (
                    <div style={{ marginTop: '0.5rem', animation: 'fadeIn 0.5s ease' }}>
                        <div style={{ marginBottom: '0.5rem', padding: '0.8rem', background: 'rgba(20, 20, 20, 0.6)', border: '1px solid rgba(255, 68, 68, 0.3)', borderRadius: '12px', boxShadow: '0 0 25px rgba(255, 68, 68, 0.15)', backdropFilter: 'blur(10px)', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
                            ...
                            <p style={{ fontSize: '1rem', fontWeight: '600', fontStyle: 'italic', lineHeight: '1.3', color: '#fff', textShadow: '0 2px 10px rgba(0,0,0,0.5)', position: 'relative', margin: 0 }}>"{result.teaser_roast}"</p>
                        </div>

                        <div style={{ position: 'relative', minHeight: '260px' }}>
                            {!isPaid && (
                                <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.5)', backdropFilter: 'blur(2px)', zIndex: 10, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', borderRadius: '12px', textAlign: 'center', padding: '0.7rem' }}>
                                    <h2 style={{ fontSize: '1.7rem', marginBottom: '0.3rem', textShadow: '0 0 28px rgba(255,0,0,0.9)', color: '#fff', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '7px' }}>
                                        🔒 <span>LOCKED</span>
                                    </h2>

                                    <div style={{ textAlign: 'left', marginBottom: '0.4rem', background: 'rgba(0,0,0,0.8)', padding: '0.55rem 0.75rem', borderRadius: '11px', border: '1px solid rgba(255,68,68,0.2)', width: '90%', maxWidth: '275px', boxShadow: '0 9px 28px rgba(0,0,0,0.5)' }}>
                                    ...
                                    <button className="btn" onClick={handleUnlock} style={{ transform: 'scale(1.03)', marginBottom: '0.2rem', boxShadow: '0 0 28px rgba(255, 68, 68, 0.5)', padding: '0.8rem 1.5rem', fontSize: '0.88rem', fontWeight: 'bold', border: '1px solid #ff4444' }}>
                                        UNLOCK NOW • 2.99€
                                    </button>
